...
# ─────────────────────────────────────────────────────────
def env(nom, defaut=""):
    """GitHub Actions injecte une chaîne vide quand un secret n'existe pas :
    os.environ.get(nom, defaut) renverrait donc "" et jamais le défaut."""
...
OUTPUT_DIR = env("FORMATIONS_OUTPUT_DIR", "formations")
